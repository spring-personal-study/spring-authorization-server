...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
    ...
    private RegisteredClient toObject(Client client) {
        Set<String> clientAuthenticationMethodStrings = StringUtils.commaDelimitedListToSet(
                client.getClientAuthenticationMethods());
        Set<String> authorizationGrantTypeStrings = StringUtils.commaDelimitedListToSet(
        ...
        RegisteredClient.Builder builder = RegisteredClient.withId(client.getId())
                ...
                .clientAuthenticationMethods(methods -> {
                    for (String method : clientAuthenticationMethodStrings) {
                        methods.add(resolveClientAuthenticationMethod(method));
                    }
                })
                .authorizationGrantTypes(grantTypes -> {
                    for (String grantType : authorizationGrantTypeStrings) {
